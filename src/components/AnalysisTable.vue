<template>
  <DataTable :value="eventsStore.events" tableStyle="table-layout: fixed;">
    ...
    <Column field="parentId" header="PId" headerClass="w-6rem" :sortable="true"></Column>
    <Column field="name" header="Name" headerClass="w-20rem" :sortable="true"></Column>
    <Column field="summary" header="Sum" headerClass="w-6rem" :sortable="true">
    ...
    <Column field="duration" header="Dur" headerClass="w-6rem" :sortable="true">
      <template #body="slotProps">
        <span>{{
